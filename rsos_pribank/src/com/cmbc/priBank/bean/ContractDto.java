...
public class ContractDto extends ProcessPublicDto implements Serializable {
	private static final long serialVersionUID = 1L;
	
	public static String processKey = "CP";	//标示流程类别
	public static String processTypeName = "理财产品合同流程"; //流程类型名
