...
<html>
	...
	<script type="text/javascript">
			$(function()
			{
				...
				$('#t_taskList').datagrid({
					...
					fit:true ,
					height:450 ,
					url:'processBaseAction!completedTasksAction.action',
					fitColumns:false ,  
					striped: true ,					
					...
					columns:[[
						...
						{field:'currentUserName' ,title:'当前办理人' ,width:150},
						{field:'currentDepartment' ,title:'当前办理机构' ,width:150}
					]] ,
					pagination: true , 
					pageSize: 10 ,
					pageList:[10,20,50] ,
  ...
  <body style="overflow:hidden">
	<div id="lay" class="easyui-layout" style="width:100%;height:100%" >
			<div region="north" title="已完成任务查询" style="height:90%;overflow:hidden" >
			<form id="mysearch" method="post">
				<table width="100%">
					<tr>
						...
						<td width="35%">&nbsp;发&nbsp;起&nbsp;日&nbsp;期:&nbsp;<input name="startTime1" id="startTime1" class="easyui-datebox" value="" style="width:90%;"/>&nbsp;至&nbsp;<input name="startTime2" id="startTime2" class="easyui-datebox" value="" style="width:90%;"/></td>
						<td width="20%"></td>
					</tr>
					<tr>
						<td width="20%">&nbsp;流&nbsp;程&nbsp;标&nbsp;题:&nbsp;<input name="topic" value="" style="width:55%;height:22px;border:1px solid #A4BED4;"/>		
						<td width="25%">流&nbsp;&nbsp;&nbsp;程&nbsp;&nbsp;&nbsp;类&nbsp;&nbsp;&nbsp;型:<input name="processTypeName" value="" style="width:55%;height:22px;border:1px solid #A4BED4;"/></td>	
						<td width="35%">&nbsp;办&nbsp;理&nbsp;日&nbsp;期:&nbsp;<input name="completeTime1" id="completeTime1" class="easyui-datebox" value="" style="width:90%;"/>&nbsp;至&nbsp;<input name="completeTime2" id="completeTime2" class="easyui-datebox" value="" style="width:90%;"/></td>
