			...
			<table>
   				<tr>
   					<td colspan="2">
   						...
   						<a href="javascript:void(0)" id="cancel" class="easyui-linkbutton">取消流程</a>
    		 	...
    		 	<div align="center">
     				<table width="80%" border="1" align="center" style="background-color:#E4F5EF">
    					<tr>
							...
							<td width="25%">&nbsp;<input id="processTypeName" name="processTypeName" style="background-color: #E1E6E9;width:80%;height:22px;border:1px solid #A4BED4;" readonly="readonly"></td>
    					...
    					<tr>
    						...
    						<td colspan="3">&nbsp;<input id="codeId" type="text" name="codeId" readonly="readonly" style="background-color: #E1E6E9;width:80%;height:22px;border:1px solid #A4BED4;"/></td>
    					</tr>
   						<tr>
