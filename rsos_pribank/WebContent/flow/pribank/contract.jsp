    			...
    			<input type="hidden" id="business" name="businessId"/>
    		 	<div class="title" align="center">
    		 		<table>
    		 			<tr>
    		 				<td>
    		 					<h4>理财产品合同流程(<font style="color:red">*必填</font>)</h4>
    		 				</td>
    		 			</tr>
    		 		</table>
    				<table width="80%" border="1" align="center" style="background-color:#E4F5EF">
    					...
    					<tr>
		    				...
		    				<td colspan="3">&nbsp;<input id="remark" type="text" name="remark" value="" style="width:30%;height:22px;border:1px solid #A4BED4;"/></td>
		    			</tr>		    					    					    					    					    					    					
    				</table>
    			</div>
    		</form>
