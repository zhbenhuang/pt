						 ...
						 columns:[[
							{
					           ...
					           field:'redempStatus',title:'产品赎回状态',width:100 ,
					           formatter:function(value , record , index){
									if(value == "产品未赎回"){
										return '<span style=color:red; >产品未赎回</span>' ;
									}else if(value == "产品赎回中"){
										return '<span style=color:green; >产品赎回中</span>' ;
									}else if(value == "赎回确认"){
										return '<span style=color:green; >赎回确认</span>' ;
									}else if(value == "产品已赎回"){
										return '<span style=color:blue; >产品已赎回</span>' ;
									}
								}
			                },{
								 ...
								 handler:function(){
								 	...
								 	if(trNum===1){
									 	...
									 	if(arr.length <=0){
									 		...
									 		if(arr[0].redempStatus!="产品未赎回"){
									 			var str = arr[0].redempStatus;
									 			LG.showWarn("提示信息",str+",不可重复启动流程!");
									 		}else{
    ...
    <div id="customeConDialog" title="选择客户合同" modal=false draggable=true class="easyui-dialog" closed=true style="width:800px;height:450px">
		<div id="lay" class="easyui-layout" style="width:100%;height:100%" >
			...
			<div region="center" style="overflow:auto;background-color:#E4F5EF;width:100%;height:100%">
				<table id="customeConList" title="客户赎回合同" class="easyui-datagrid" align="center" border="1" style="height:auto;background-color:#E4F5EF">
				</table>
			</div>
		</div>
	</div>
