...
<jsp:include page="selectRedemption.jsp"></jsp:include>
			...
			if(contractId==''){
				...
				$.messager.confirm('提示消息','确认启动流程?',function(r){
					if(r){
						$.ajax({
							type: 'post' ,
							url: 'redempProcess!startRedempAction.action',
							cache:false,
	...
	<div id="lay" class="easyui-layout" style="width: 100%;height:100%" >
		...
		<br>
			<form id="my_form" action="" method="post">
    				...
    				<div class="title" align="center"><table><tr><td><h3>理财产品赎回流程(<font style="color:red">*必填</font>)</h3></td></tr></table></div>
    				<table width="90%" border="1" align="center" style="background-color:#E4F5EF">
    					...
    					<tr>
    						<td align="center"><font color="red">输入赎回单条码&nbsp;*</font></td>
