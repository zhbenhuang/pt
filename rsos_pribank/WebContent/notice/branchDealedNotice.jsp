	...
	<script type="text/javascript">
			$(function(){
				...
				$('#t_noticeList').datagrid({
					...
					fit:true ,
					height:450 ,
					url:'contractAction!getDealedNoticesList.action',
					fitColumns:true ,  
					striped: true ,					
					...
					columns:[[
						{
   							...
   							return '<a href="javascript:void(0)" onclick="viewNoticeHref(\'' + row.noticeId+ '\')">'+row.noticeTitle+'</a>'}},
   						{
							...
							field:'noticeViewTime',title:'查阅时间',width:80
						},{
							field:'noticeDealStatus',title:'处理状态',width:60
						},{
							field:'noticeDealTime',title:'处理时间',width:80
						},{
							field:'belongDepartment',title:'处理机构',width:80
						}
					]] ,
					pagination: true , 
					pageSize: 10 ,
			...
			function closeViewDialog(){
				...
				$('#t_noticeList').datagrid('unselectAll');	
			}
			//js方法：序列化表单 			
			...
			<form id="mysearch" method="post">
				<table width="100%">
					<tr>
						...
						<td width="40%">&nbsp;处理日期:&nbsp;<input name="dealDateBegin" id="arriveDateBegin" class="easyui-datebox" value="" style="width:120%;"/>&nbsp;至&nbsp;<input name="dealDateEnd" id="arriveDateEnd" class="easyui-datebox" value="" style="width:120%;"/></td>
